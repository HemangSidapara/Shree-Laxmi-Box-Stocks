...
import 'package:shree_laxmi_box_stocks/Network/services/utils_services/install_apk_service.dart';
...
import 'package:shree_laxmi_box_stocks/Utils/in_app_update_dialog_widget.dart';
  ...
  void onInit() async {
    ...
    newAPKUrl.addListener(GetStream(
      onListen: () async {
        ...
        currentVersion.value = pkgInfo.version;
        if (kDebugMode) {
